  ...
  <div>
    <div :class="cClass">
      <div class="cart-menu">
        ...
        <div class="row justify-content-between" style="background:#009038 ;padding:10px 10px 10px 10px" v-if="this.cartPrice != undefined">
          <div class="flex-column pl-3">
            <h4>ยอดเงินที่ต้องชำระ</h4>
          </div>
